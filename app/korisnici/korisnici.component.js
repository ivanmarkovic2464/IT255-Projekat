System.register(['angular2/core', 'angular2/common', 'angular2/http', 'rxjs/Rx', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            KorisniciComponent = (function () {
                function KorisniciComponent(builder, http, router) {
                    var _this = this;
                    this.http = http;
                    this.router = router;
                ...
                KorisniciComponent.prototype.remove = function (item) {
                    var _this = this;
                    console.log("Remove: ", item);
                    var headers = new http_1.Headers();
                    headers.append('Content-Type', 'application/x-www-form-urlencoded');
                    this.http.get('http://localhost/PHP/obrisiKorisnika.php?korisnici_ID=' + item, { headers: headers }).subscribe(function (data) { return _this.postResponse = data; });
                    location.reload();
                };
            ...
            exports_1("KorisniciComponent", KorisniciComponent);
        }
    }
});
